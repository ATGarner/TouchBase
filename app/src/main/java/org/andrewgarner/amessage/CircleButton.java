...
/**
 * Fun circular button made by Markushi on Github
 * Link: https://github.com/markushi/android-circlebutton
 * I modified a few of the paramaters to the button
 */
public class CircleButton extends ImageView {

    private static final int PRESSED_COLOR_LIGHTUP = 255 / 25;
    private static final int PRESSED_RING_ALPHA = 75;
    private static final int DEFAULT_PRESSED_RING_WIDTH_DIP = 13;
